...
def set_iid(y_train,x_train):
    ...
    strategy_dict = dict(zip([i for i in range(10)], [100 for i in range(10)]))


    x_resampled, y_resampled = RandomUnderSampler(sampling_strategy=strategy_dict).fit_resample(flat_x, flat_y)
