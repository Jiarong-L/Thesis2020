...
class Fed_Training():
    ...
    def __init__(self,model,nodes_path,central_path,x_test, y_test,batch_size = 50,augument=False):
        self.model=model
        self.epo=0
    ...
    def delayed_node_train_step(self):
        ...
        for index_path in self.delayed_index:
            ...
            model_weights, nb=node_training_process(index_path,self.shared_index,self.central_p,self.local_epoch,self.batch_size,self.augument)
